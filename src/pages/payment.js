    ...
    <>
      ...
      <div className="payment__popup payment__refund">
        ...
        <main>
          ...
          <ul>
            ...
            <li>
              We Offer 1 Free return on all orders Except Sale Items. If you are
              wanting a second return we will have to charge for it. Returning
              for an exchange is R75, returning for a refund is R50. We do not
              do returns on Caps/Watches and Sale items Last Pairs & Sale
              Clothing.
            </li>
            <li>
            ...
            <li>
              If an item sent to you is the wrong size/item then we will get it
              returned to us using express and your follow up delivery will also
              be express. Credit Card Refunds take up to anywhere from 7-10
              working days by law.
            </li>
            <li>
      ...
      <div className="payment__popup payment__shipping">
        ...
        <main>
          ...
          <p>
            Jacklemkus.com uses only the best courier companies when delivering
            your product. Please see below the different options you have on how
            to receive your product, please also see a brief terms and
            conditions section around delivery.
          </p>
          ...
          <ul>
            ...
            <li>
              Under Armour product is NOT kept on site, please note it can take
              2-5 working days to effect delivery.
            </li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li>
              Please note if you pay via EFT, you will be sent an email letting
              you know when we have received the payment and after such, can
              come and collect your order.
            </li>
            <li>
              EFT Payment Method: Please note we can not be liable If the
              product you ordered is sold before you email us proof of payment,
              we can keep product aside for 1HOUR Important Points: We want to
              help you have the best e-commerce experience we possibly can,
              please see our very basic terms & conditions below:
            </li>
            <li>
              Our trusted courier partners are hand to hand couriers,no P.O Box
              Addresses
            </li>
            <li>
              ...
              failed second attempt we will charge you R75 for the next attempt.
            </li>
            <li>Cheques are not accepted</li>
            <li>The Courier Operates from 8:00AM-17:00PM, Monday to Friday</li>
            <li>
              All orders received after 15:30PM will only leave the next working
              day
            </li>
            <li>
            ...
            <li>
              Orders with incorrect billing information, or requiring additional
              verification, will be delayed.
            </li>
            <li>Order may be delayed if the following applies:</li>
            <li>
              Customer is not present to receive order delivery is effected
              twice by the courier, if customer is still not present to sign for
              order, it is returned to Jack Lemkus
            </li>
      ...
      <div className="payment__popup payment__privacy">
        ...
        <main>
          ...
          <p>
            ...
            Jack Lemkus is committed to ensuring that your privacy is protected.
            ...
            Lemkus may change this policy from time to time by updating this
          ...
          <p>
            ...
            <br />
            We will not provide this information to any third parties or use it
          ...
          <p>
            ...
            writing to or emailing us at info@jacklemkus.co.za <br />
            <br />
            ...
            <br /> You may request details of personal information which we hold
            ...
            please write to 26 St Georges Mall Cape Town CBD South Africa or
          ...
          <p>
            ...
            <br />
            <br />
            POPI stands for Protection of Personal Information Act and has come
            into effect as of 1st of July 2021.
            <br />
            <br />
        ...
        <main>
          ...
          <ul>
            ...
            <li>
              ...
              reviews to help you make you choice, we understand every purchase
              is a big decision so we will try to equip you with as much
            ...
            <li>
              ...
              you’re a first time buyer) or go straight to the payment page (if
          ...
          <p>
            ...
            <br />
            <br />
            Standard Bank - Standard Bank cardholders do not need to register or
            activate 3D Secure. Proceed to checkout and follow the prompts.
            <br />
            <br />
            ...
            <br />
            <br />
            Nedbank - Nedbank cardholders do not need to register or activate 3D
            Secure.
            <br />
            <br />
            Investec - Investec cardholders must use their credit card pins when
            prompted to submit the One Time Pin (OTP) in the checkout.
            <br />
            <br />
            Capitec - If you've already registered or activated your card for 3D
            Secure with Capitec, simply enter your personal SecureCode password
            on the checkout screen. Please go here and follow the instructions.
            <br />
            <br />
            SecureCode Customers (MasterCard) (If you bank with an Institution
            other than the above): Please visit the the Securecode website here
            <br />
            <br />
            Verified by Visa Customers (VISA): Customers with VISA Cards that do
            not bank with one of the above need no longer register their Cards
            to checkout, please see the Visa website here for further
            explanation
          </p>
          ...
          <ul>
            ...
            <li>
              No refunds, Only credit notes allowed (Credit note can not be used
              to Laybye, only as a Final Payment)
            </li>
